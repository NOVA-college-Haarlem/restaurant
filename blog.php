                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 display-posts">
                            <!-- post-->
                            <article class="post">
                                <h4><a href="blog-single.html" class=" transition2">A Classic and Effective Blog Design</a></h4>
                                <ul class="post-meta">
                                    <li>02 Frb</li>
                                    <li>22 com</li>
                                ...
                                <div class="post-media">
                                    <div class="single-slider-holder">
                                        ...
                                        <div class="single-slider owl-carousel">
                                            <!-- 1 -->
                                            <div class="item">
                                                <img src="images/gallery/1.jpg" class="respimg" alt="">
                                            </div>
                                            <!-- 2 -->
                                            <div class="item">
                                                <img src="images/gallery/1.jpg" class="respimg" alt="">
                            ...
                            <article class="post">
                                ...
                                <div class="post-media">
                                    <a href="blog-single.html" class=" "><img src="images/gallery/1.jpg" alt="" class="respimg"></a>
                                </div>
                                <p>Etiam in nulla arcu, ut vehicula velit. Vivamus dapibus rutrum mi ut aliquam. In hac habitasse platea dictumst. Integer sagittis neque a tortor tempor in porta sem vulputate. Donec varius felis fermentum nisl imperdiet at molestie purus porta...</p>
                                <a href="blog-single.html" class=" post-link">Continue reading ...</a>
                                <ul class="post-tags">
                            ...
                            <!-- post-->
                            <article class="post">
                                <h4><a href="blog-single.html" class=" transition2">Video in Web Design</a></h4>
                                <ul class="post-meta">
                                    <li>02 Frb</li>
                                    <li>22 com</li>
                                    <li><i class="fa fa-heart-o"></i> 151</li>
